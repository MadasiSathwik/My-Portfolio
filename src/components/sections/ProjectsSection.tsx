...
const projects = [
  ...
  {
    title: "Gesture Controlled Flappy Bird",
    description: "A futuristic hands-free gaming experience where users control the game using real-time hand gestures powered by computer vision and AI.",
    image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=1200&auto=format&fit=crop",
    tech: ["Python", "MediaPipe", "OpenCV", "Pygame"],
    githubUrl: "https://github.com/MadasiSathwik/Gesture-Controlled-Flappy-Bird",
  },
];
